...
Route::post('/index/liked',[\App\Http\Controllers\AuthMainController::class,'like'])->name('like')->middleware('auth:sanctum');
Route::post('/index/delliked',[\App\Http\Controllers\AuthMainController::class,'deleteLike'])->name('delike')->middleware('auth:sanctum');
